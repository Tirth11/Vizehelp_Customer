  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TextInput style={styles.textarea} placeholder="Write a review (optional)" multiline numberOfLines={4} value={review} onChangeText={setReview} placeholderTextColor={COLORS.textDisabled} />
...
const styles = StyleSheet.create({
  ...
  star: { fontSize: 40 },
  ratingLabel: { ...FONTS.body, color: COLORS.textLight, marginTop: 12 },
  textarea: { backgroundColor: COLORS.background, borderRadius: SIZES.radius, paddingHorizontal: 16, paddingVertical: 14, ...FONTS.body, borderWidth: 1, borderColor: COLORS.border, width: '100%', height: 100, textAlignVertical: 'top', marginTop: 24 },
  tipLabel: { ...FONTS.h3, color: COLORS.text, marginTop: 24, alignSelf: 'flex-start' },
  tipRow: { flexDirection: 'row', gap: 12, marginTop: 12 },
  tipBtn: { paddingHorizontal: 20, paddingVertical: 12, borderRadius: SIZES.radius, backgroundColor: COLORS.background, borderWidth: 1, borderColor: COLORS.border },
