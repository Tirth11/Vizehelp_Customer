    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.center}>
        ...
        <View style={styles.otpCard}>
          ...
          <Text style={styles.otpNote}>Share this code only after confirming your Buddy has arrived.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  otpCard: { backgroundColor: COLORS.primaryLight, borderRadius: SIZES.radiusLg, padding: SIZES.lg, alignItems: 'center', marginTop: 30, width: '100%', borderWidth: 1, borderColor: COLORS.primary },
  otpLabel: { ...FONTS.bodySm, color: COLORS.textLight },
  otpCode: { ...FONTS.h1, color: COLORS.primary, letterSpacing: 8, marginVertical: 12, fontSize: 36, fontWeight: '700' },
  otpNote: { ...FONTS.caption, color: COLORS.error, textAlign: 'center' },
