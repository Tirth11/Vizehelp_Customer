    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.promoRow}>
          <TextInput style={styles.promoInput} placeholder="Promo code" value={promo} onChangeText={setPromo} placeholderTextColor={COLORS.textDisabled} />
          <TouchableOpacity style={styles.applyBtn}><Text style={styles.applyText}>Apply</Text></TouchableOpacity>
        </View>

        <View style={styles.summaryCard}>
          <Text style={styles.summaryTitle}>Price Summary</Text>
          <View style={styles.row}><Text style={styles.rowLabel}>Service Price</Text><Text style={styles.rowValue}>${total}.00</Text></View>
          <View style={styles.row}><Text style={styles.rowLabel}>Taxes</Text><Text style={styles.rowValue}>$2.10</Text></View>
...
const styles = StyleSheet.create({
  ...
  methodCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.white, borderRadius: SIZES.radiusLg, padding: SIZES.lg, marginBottom: 10, borderWidth: 1.5, borderColor: COLORS.border, ...SHADOWS.small },
  ...
  promoInput: { flex: 1, backgroundColor: COLORS.white, borderRadius: SIZES.radius, paddingHorizontal: 16, paddingVertical: 12, borderWidth: 1, borderColor: COLORS.border, ...FONTS.body },
  applyBtn: { backgroundColor: COLORS.primary, borderRadius: SIZES.radius, paddingHorizontal: 20, justifyContent: 'center' },
  applyText: { ...FONTS.bodySm, color: COLORS.white, fontWeight: '600' },
  summaryCard: { backgroundColor: COLORS.white, borderRadius: SIZES.radiusLg, padding: SIZES.lg, marginTop: 20, ...SHADOWS.small },
  summaryTitle: { ...FONTS.h3, color: COLORS.text, marginBottom: 12 },
  ...
  footer: { padding: SIZES.lg, backgroundColor: COLORS.white, borderTopWidth: 1, borderTopColor: COLORS.border },
